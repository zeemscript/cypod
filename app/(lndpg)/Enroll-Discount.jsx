  ...
  return (
    <section className="relative min-h-[80vh] flex flex-col md:flex-row bg-gradient-to-br from-[#e0f7fa] via-[#f8fafc] to-[#e0f2f1] overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative z-20 py-16 px-4">
        <div className="w-full max-w-2xl mx-auto bg-white/95 rounded-3xl shadow-xl p-10 border border-[#e0e7ef] relative">
          {/* Discount Badge */}
          <span className="absolute -top-8 left-10 bg-[#2bb3a2] text-white px-8 py-3 rounded-full shadow text-xl font-extrabold border-2 border-[#ff8c2b]">
            30% OFF
          </span>
          ...
          <button
            type="button"
            className="bg-[#2bb3a2] hover:bg-[#29434e] text-white font-extrabold py-4 px-10 w-full rounded-xl shadow text-2xl transition-all flex items-center justify-center gap-3"
            onClick={() => {
