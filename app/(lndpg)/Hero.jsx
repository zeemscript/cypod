...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16 flex items-center justify-center">
        <div className="grid  gap-12 lg:gap-16 items-center w-full">
          ...
          <div className="text-center  space-y-8 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center  w-full">
              ...
              <button className="group bg-white/80 backdrop-blur-sm hover:bg-white text-[#29434e] font-semibold py-4 px-8 rounded-xl border border-[#29434e]/10 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 w-full sm:w-auto">
                View Course Catalog
              </button>
            </div>
          </div>
